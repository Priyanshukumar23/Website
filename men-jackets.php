        ...
        <section class="products-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Premium Bomber Jacket', 8999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Classic Denim Jacket', 6999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Winter Puffer Jacket', 12999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Premium Leather Jacket', 15999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Hooded Jacket', 5999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Sports Windbreaker', 7999)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
