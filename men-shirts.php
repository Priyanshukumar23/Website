...
<head>
    ...
    <title>Men's Shirts - Kumar Brothers</title>
...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/shirt.jpg" alt="Men's Shirts Collection" class="hero-image">
            <div class="hero-content">
                <h1>Men's Shirts Collection</h1>
                <p>Discover our premium collection of formal and casual shirts</p>
            </div>
        </section>

        <section class="search-container">
            <div class="search-bar">
                <input type="text" id="searchInput" placeholder="Search for shirts...">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/shirt.jpg" alt="Lee Shirt" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Classic Fit Shirt', 1299)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt2m.jpg" alt="Monte Carlo Shirt" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Slim Fit Shirt</h3>
                    <p class="product-brand">Monte Carlo</p>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Slim Fit Shirt', 1499)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt3m.jpg" alt="Allen Solly Shirt" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Regular Fit Shirt</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Regular Fit Shirt', 1799)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt4m.jpg" alt="Peter England Shirt" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Formal Shirt', 1599)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt5m.jpg" alt="Van Heusen Shirt" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Premium Shirt', 1999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt6m.jpg" alt="Arrow Shirt" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Executive Shirt</h3>
                    <p class="product-brand">Arrow</p>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Executive Shirt', 1899)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
