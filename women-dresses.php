...
<head>
    ...
    <title>Women's Dresses - Kumar Brothers</title>
...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/dw1.jpeg" alt="Women's Dresses Collection" class="hero-image">
            <div class="hero-content">
                <h1>Women's Dresses Collection</h1>
                <p>Discover our stunning collection of dresses for every occasion</p>
            </div>
        </section>

        <section class="search-container">
            <div class="search-bar">
                <input type="text" id="searchInput" placeholder="Search dresses...">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/dw1.jpeg" alt="Floral Maxi Dress" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Floral Maxi Dress</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Floral Maxi Dress', 4999)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/dw2.jpeg" alt="Little Black Dress" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Little Black Dress</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Little Black Dress', 3499)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/dw3.jpeg" alt="Summer Sundress" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Summer Sundress</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Summer Sundress', 2999)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/dw4.jpeg" alt="Cocktail Dress" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Cocktail Dress</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Cocktail Dress', 5499)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
