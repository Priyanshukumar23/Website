...
<head>
    ...
    <title>Women's Footwear - Kumar Brothers</title>
...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/fww1.jpeg" alt="Women's Footwear Collection" class="hero-image">
            <div class="hero-content">
                <h1>Women's Footwear Collection</h1>
                <p>Step out in style with our trendy footwear collection</p>
            </div>
        </section>

        <section class="search-container">
            <div class="search-bar">
                <input type="text" id="searchInput" placeholder="Search footwear...">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/fww1.jpeg" alt="Stiletto Heels" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Classic Stiletto Heels</h3>
                    <p class="product-brand">Jimmy Choo</p>
                    <p class="product-price">₹24,999</p>
                    <div class="size-options">
                        <button class="size-btn" onclick="selectSize(this)">36</button>
                        <button class="size-btn" onclick="selectSize(this)">37</button>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Classic Stiletto Heels', 24999)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/fww2.jpeg" alt="Ballet Flats" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Comfortable Ballet Flats</h3>
                    <p class="product-brand">Steve Madden</p>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Comfortable Ballet Flats', 4999)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/fww3.jpeg" alt="Ankle Boots" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Leather Ankle Boots</h3>
                    <p class="product-brand">Aldo</p>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Leather Ankle Boots', 7999)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/fww4.jpeg" alt="Sneakers" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Fashion Sneakers', 5999)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
