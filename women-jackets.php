...
<head>
    ...
    <title>Women's Jackets - Kumar Brothers</title>
...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/jaw1.jpeg" alt="Women's Jackets Collection" class="hero-image">
            <div class="hero-content">
                <h1>Women's Jackets Collection</h1>
                <p>Stay stylish and warm with our trendy jacket collection</p>
            </div>
        </section>

        <section class="search-container">
            <div class="search-bar">
                <input type="text" id="searchInput" placeholder="Search jackets...">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/jaw1.jpeg" alt="Leather Jacket" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Classic Leather Jacket', 6999)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/jaw2.jpeg" alt="Denim Jacket" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Casual Denim Jacket</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Denim Jacket', 4499)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/jaw3.jpeg" alt="Bomber Jacket" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Stylish Bomber Jacket</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Stylish Bomber Jacket', 3999)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="img2/jaw4.jpeg" alt="Blazer" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Professional Blazer</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Professional Blazer', 5499)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
