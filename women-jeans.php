...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/jw1.jpeg" alt="Women's Jeans Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/jw1.jpeg" alt="Slim Fit Jeans" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Slim Fit Jeans', 2999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/jw2.jpeg" alt="Skinny Jeans" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Skinny Jeans', 3499)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/jw3.jpeg" alt="Bootcut Jeans" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Bootcut Jeans', 3299)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/jw4.jpeg" alt="High Waist Jeans" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('High Waist Jeans', 3799)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
