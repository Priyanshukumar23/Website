...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/kurti.jpg" alt="Women's Kurtis Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/kurti.jpg" alt="Floral Print Kurti" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Floral Print Kurti', 1999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/kurti2.jpg" alt="Embroidered Kurti" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Embroidered Kurti', 1499)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/kurti3.jpg" alt="Printed Kurti" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Printed Kurti', 1299)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/kurti4.jpg" alt="Designer Kurti" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Designer Kurti', 1799)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/kurti5.jpg" alt="Casual Kurti" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Kurti', 999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/kurti6.jpg" alt="Traditional Kurti" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Traditional Kurti', 1599)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
