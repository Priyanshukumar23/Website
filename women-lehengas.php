...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/skirt1w.jpg" alt="Women's Lehengas Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/skirt1w.jpg" alt="Traditional Lehenga" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Traditional Lehenga', 4999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/skirt2w.jpg" alt="Designer Lehenga" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Designer Lehenga', 4499)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/skirt3w.jpg" alt="Bridal Lehenga" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Bridal Lehenga', 4799)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/skirt4w.jpg" alt="Party Lehenga" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Party Lehenga', 3999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/skirt5w.jpg" alt="Contemporary Lehenga" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Contemporary Lehenga', 4299)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/skirt6w.jpg" alt="Fusion Lehenga" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Fusion Lehenga', 3499)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
