...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="img2/shirt1w.jpg" alt="Women's Tops Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="img2/shirt1w.jpg" alt="Casual Top" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Top', 1299)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt2w.jpg" alt="Formal Top" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Formal Top', 999)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt3w.jpg" alt="Party Top" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Party Top', 1499)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt4w.jpg" alt="Designer Top" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Designer Top', 1199)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt5w.jpg" alt="Printed Top" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Printed Top', 899)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="img2/shirt6w.jpg" alt="Casual Top" class="product-image">
                <div class="product-info">
                    <h3 class="product-title">Casual Top</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Top', 1099)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
